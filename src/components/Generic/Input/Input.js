      ...
      >
        ...
        >
          <Input
            ...
            className="login-form-input"
            placeholder="O`quv markazingiz nomi" />
        </Form.Item>
        <Form.Item
          name="text"
          rules={[
        ...
        >
          <Input
            ...
            className="login-form-input"
            type="text"
            placeholder="Telegram manzilingiz"
          />
        </Form.Item>
        <Form.Item>
        </Form.Item>
        ...
        <Form.Item>
          <Button onClick={(e) => TeleChat(e)} type="primary" htmlType="submit" className="login-form-button">DEMO OLISH</Button>
          <p className='login-form-p'>Sizning barcha ma`lumotlaringiz xavfsizligi qonun doirsida himoya qilinadi</p>
          <p></p>
        </Form.Item>
      </Form>
    </div>
